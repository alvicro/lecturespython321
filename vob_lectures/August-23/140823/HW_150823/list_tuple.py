...
# сложить два списка
# сравнить два списка циклом (for "почти" не подойдёт)
# создать список букв слова "кенгуру"
# создать список разных букв строки, введенной с клавиатуры


# https://docs.google.com/presentation/d/1WwaNvCTNGAAh0qDxweL1QTxmpy0TXYEwBCylR0gN4n4
